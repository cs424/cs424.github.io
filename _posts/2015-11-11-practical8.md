...
**0.**
Finish [Practical Sheet 7]({% post_url 2015-11-04-practical7 %}).  
...
quotes, rather than single quotes, to have the
placeholder `#{@user.name}` automatically replaced by the user's name.)
...
called before the processing then action has even started.  This would
